    ...
    <section className="w-full px-4">
      <div className="relative container m-auto border-x border-r border-l border-t border-[--grey-border] border-dashed lg:mt-16 mt-4 shadow-special-1 rounded-t-xl lg:px-0">
        <div className="flex flex-col justify-center lg:flex-row">
          <div className="flex flex-col items-center gap-8 justify-center absolute left-1/2 -translate-x-1/2 top-20 w-full">
            <Smalltitle>Fémkereskedelem felső fokon</Smalltitle>
            <H1 classname={"lg:text-7xl md:6xl 5xl text-center min-w-fit"}>
              Metalcu Trade Kft.
            </H1>
          </div>
        </div>
