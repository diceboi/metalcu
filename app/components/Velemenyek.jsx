...
export default function Velemenyek() {
  return (
    <section className="relative w-full px-4">
        <div className='container m-auto border border-dashed border-[--grey-border] lg:px-0'>
            <div className='grid lg:grid-cols-3'>
            
                <div className='col-span-1 lg:p-8 px-4 z-10 bg-[--lightgrey] lg:min-h-[100vh] '>
                    <div className='sticky lg:top-20 top-24 flex flex-col gap-2 py-8'>
                ...
                <div className='flex flex-col col-span-2 w-full'>
                    ...
                    <div className='flex flex-col gap-2 p-4 border-y lg:border-l border-[--grey-border]'>
                    ...
                    <div className='flex flex-col gap-2 p-4 lg:border-b lg:border-l border-[--grey-border]'>
                        <div className='flex flex-nowrap gap-2 items-center'>
